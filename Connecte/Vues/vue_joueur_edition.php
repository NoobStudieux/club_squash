<!DOCTYPE html>		<!-- localhost/www/Php_MySql/Php_PoO/poo_2.9_TP_Matchs/Connecte/Vues/vue_joueur_edition.php -->
<html>
	<head>
...
<div class="Conteneur">
	...
	<div class="element">
			...
			<div>
				...
				<form action="Connecte/Joueur/module_joueur_edition_nom.php" method="post">
					...
					<label for="validite">validité : </label><input type="text" name="validite" disabled="true" value=<?php echo $joueur->validite(); ?> />
									<?php 	
												...
												{
									?>
														<form action="Connecte/Joueur/module_joueur_edition_se_blesse.php" method="post">
									...
									<?php
												...
												{
									?>
														<form action="Connecte/Joueur/module_joueur_redevient_valide.php" method="post">
...
<div class="affichAdmin">
	<a href="Connecte/Model/module_deconnexion.php">Deconnexion</a>
</div>

<div class="affichCreerTables">

		<ul>
				<li><a href="Connecte/Model/module_vers_accueil.php">retour accueil</a> <br /></li>
		</ul>
