<?php		//		localhost/www/Php_MySql/Php_PoO/poo_2.9_TP_Matchs/Model/POST_tables_reinit.php
...
header("Location:module_vers_accueil.php"); // ne mar'che plus qd situé en fin de document ??
